  ...
  <div class="form-group">
      ...
      <label class="form-label {if $field.required}required{/if}" for="f-{$field.name}_{$uniqId}">
        ...
        {block name='form_field_comment'}
          {if (!$field.required && !in_array($field.type, ['radio-buttons', 'checkbox']))}
            <small class="text-muted d-inline-block d-xl-none">({l s='Optional' d='Shop.Forms.Labels'})</small>
          {/if}
        {/block}
      </label>
    {/if}
    ...
    {if $field.type === 'select'}
      ...
      {block name='form_field_item_select'}
        ...
        <small class="text_optional text-muted d-none d-xl-block">&nbsp;</small>
      {/block}
    ...
    {elseif $field.type === 'password'}
      ...
      {block name='form_field_item_password'}
        ...
        {block name='form_field_comment'}
          {if (!$field.required && !in_array($field.type, ['radio-buttons', 'checkbox']))}
            <small class="text_optional text-muted d-none d-xl-block">{l s='Optional' d='Shop.Forms.Labels'}</small>
            {else}
              <small class="text_optional text-muted d-none d-xl-block">&nbsp;</small>
          {/if}
